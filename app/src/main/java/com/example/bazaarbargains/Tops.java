    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<itemShoe> options =
                new FirebaseRecyclerOptions.Builder<itemShoe>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Tops"), itemShoe.class)
                        .build();
        ...
        bottom_bar.setOnTabSelectListener(new AnimatedBottomBar.OnTabSelectListener() {
            ...
            public void onTabSelected(int lastIndex, AnimatedBottomBar.Tab lastTab, int newIndex, AnimatedBottomBar.Tab newTab) {
                ...
                if (id == 0) {
                    ...
                    startActivity(new Intent(Tops.this, Dashboard.class));
                } else if (id == 1) {


                    startActivity(new Intent(Tops.this, mainPage.class));


                }else if (id == 2) {


                    startActivity(new Intent(Tops.this, wishlist.class));


                }else if (id == 3) {


                    startActivity(new Intent(Tops.this, cartRecList.class));
